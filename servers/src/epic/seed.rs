...
const MAINNET_DNS_SEEDS: &'static [&'static str] = &[
	"mainnet.seed.epic-tech.org",      // igno.peverell@protonmail.com
	"mainnet.seed.epic.icu",           // gary.peverell@protonmail.com
	"mainnet.seed.713.mw",             // jasper@713.mw
	"mainnet.seed.epic.lesceller.com", // q.lesceller@gmail.com
	"mainnet.seed.epic.prokapi.com",   // hendi@prokapi.com
	"epicseed.yeastplume.org",         // yeastplume@protonmail.com
];
const FLOONET_DNS_SEEDS: &'static [&'static str] = &[
	"floonet.seed.epic-tech.org",      // igno.peverell@protonmail.com
	"floonet.seed.epic.icu",           // gary.peverell@protonmail.com
	"floonet.seed.713.mw",             // jasper@713.mw
	"floonet.seed.epic.lesceller.com", // q.lesceller@gmail.com
	"floonet.seed.epic.prokapi.com",   // hendi@prokapi.com
];
